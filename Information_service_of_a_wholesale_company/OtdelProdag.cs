...
namespace Information_service_of_a_wholesale_company
{
    public partial class OtdelProdag : Form
    {
        ...
        void updateScladDGV()
        {
            ...
            var request = @"SELECT NameOfItem, SUM(Quantity) AS KolVo FROM Product
            WHERE Product.ValidUntil > '" + time.ToString("yyyy-MM-dd") + "' GROUP BY NameOfItem ORDER BY KolVo DESC";
            ...
            //dataGrid_Sclad.Columns["purchasePrice"].HeaderText = "Цена";
            ...
            dataGrid_Sclad.Columns["KolVo"].HeaderText = "Количество";
        ...
        int[] numsss = new int[500];
        int Kol = 0;
        int[] Koll = new int[500];
        int[] ish_Koll = new int[500];
        int i = 1;
